...
export default function Home() {
  return (
    <div
      className="page-scale relative min-h-screen overflow-hidden bg-bg"
      style={{
        backgroundImage:
          "radial-gradient(1300px 760px at 50% -14%, rgba(224,138,92,0.20), transparent 64%), radial-gradient(900px 560px at 10% 6%, rgba(194,96,58,0.10), transparent 62%), radial-gradient(1000px 700px at 92% 40%, rgba(194,96,58,0.05), transparent 66%)",
      }}
    >
      <div
        aria-hidden
